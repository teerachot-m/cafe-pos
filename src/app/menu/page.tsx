...
import { BookOpen, Plus, Layers, Sparkles, Scale } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-stone-500">สร้างเครื่องดื่ม ขนม & ผูกสูตรคำนวณต้นทุนวัตถุดิบ</p>
        </div>
      ...
      {/* Modal: Add Product & BOM Recipe */}
      {isAddProductOpen && (
        <div className="fixed inset-0 z-50 bg-stone-900/60 backdrop-blur-xs flex items-center justify-center p-4">
          <form onSubmit={handleCreateProduct} className="cream-card max-w-lg w-full rounded-3xl p-6 border border-stone-300 max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-3 text-xs">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-stone-600 font-bold mb-1">ราคาขาย (บาท)</label>
                  <input
                    type="number"
                    step="0.01"
                    value={prodPrice}
